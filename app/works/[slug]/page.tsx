        ...
        <div className="mx-auto mb-10 max-w-5xl">
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            ...
            <div className="flex flex-wrap items-center gap-2">
              {hasUrl ? (
                <Button asChild>
                  <a href={data.url!} target="_blank" rel="noreferrer">사이트 방문</a>
                </Button>
              ) : (
            ...
            <div className="lg:sticky lg:top-28">
              <div className="mb-6 rounded-lg border p-5">
                ...
                <div className="mb-2 text-sm">
                  <span className="mr-2 text-muted-foreground">제작기간:</span>
                  <span>{data.date}</span>
                </div>
                <div className="mb-2 text-sm">
                  <span className="mr-2 text-muted-foreground">기여도:</span>
                  <span>{data.contribution}</span>
                </div>
                <div className="mb-2 text-sm">
                  <span className="mr-2 text-muted-foreground">배포:</span>
                  {hasUrl ? (
