import { categorizedSkills } from '@/portfolio-data/aboutSkillsData';
    ...
    <main className='flex-1'>
      ...
      <section className='bg-background py-12'>
        <div className='mx-auto max-w-screen-xl px-6'>
          <div className='mb-8'>
            <h1 className='mb-2 text-3xl font-bold text-gray-900 dark:text-gray-100'>기술 스택</h1>
          ...
          <div className='mt-16 rounded-xl border border-gray-200 bg-gradient-to-br from-blue-50 to-purple-50 p-8 dark:border-gray-700 dark:from-gray-800 dark:to-gray-900'>
            ...
            <a
              ...
              className='inline-flex items-center gap-3 rounded-lg bg-white px-6 py-3 font-semibold text-gray-900 shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg dark:bg-gray-800 dark:text-gray-100'
              target='_blank'
              rel='noopener noreferrer'
            >
              <Image src='/icons/notion.svg' width={32} height={32} alt='notion 경력기술서' />
              <span>경력기술서 보기</span>
