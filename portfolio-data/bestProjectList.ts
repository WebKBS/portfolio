import { namhaeImages } from '@/portfolio-data/image-data/roowa/namhaeImages';
import { StaticImageData } from 'next/image';
import { skillImageObject } from '@/portfolio-data/aboutSkillsData';
import { recodelogImages } from '@/portfolio-data/image-data/personal-project/recodelogImages';
...
export const bestProjectList: BestProject[] = [
  ...
  또한 Server Component를 활용하고 Google Search Console과 네이버 서치어드바이저를 통한 SEO 최적화로 검색엔진 노출을 개선했으며, AWS Amplify를 통한 안정적인 배포와 Route 53을 통한 도메인 관리를 구현했습니다.`,
    ...
    skills: [skillImageObject.next, skillImageObject.react, skillImageObject.typescript],
  },
  {
    id: 'recodelog',
