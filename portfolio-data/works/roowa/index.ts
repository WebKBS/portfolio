import { namhaeImages, namhaePreviewImages } from '@/portfolio-data/image-data/roowa/namhaeImages';
import { roowaintImages } from '@/portfolio-data/image-data/roowa/roowaintImages';
import { roowaImages, roowaPreviewImages } from '@/portfolio-data/image-data/roowa/roowaImages';
...
export const roowaWorks: IWorks[] = [
  {
    ...
    tags: ['Next.js', 'React', 'TypeScript', 'Tailwind CSS', 'Zustand', 'AWS Amplify'],
    ...
    detailContent: {
      ...
      functions: [
        ...
        },
        {
          ...
          description: 'Google Analytics를 사용하여 사용자 데이터를 수집하였습니다.',
        },
        {
          function: 'Google Search Console',
          description: 'Google Search Console을 사용하여 SEO 최적화를 하였습니다.',
        },
        {
  ...
  },
  {
    ...
    detailContent: {
      ...
      functions: [
        ...
        {
          function: 'NodeMailer',
          description: 'NodeMailer와 server action을 사용하여 메일을 보낼 수 있도록 하였습니다.',
        },
        {
          function: '카카오 맵 API',
          description: '카카오 맵 API를 사용하여 지도를 보여주는 기능을 추가하였습니다.',
        },
        {
          function: 'Vercel',
