...
} from '@/portfolio-data/image-data/vstro/eurasiaImages';
import { k2gbsImages, k2gbsPreviewImages } from '@/portfolio-data/image-data/vstro/k2gbsImages';
import { dpangzImages, dpangzPreviewImages } from '@/portfolio-data/image-data/vstro/dpangzImages';
...
export const vstroWorks: IWorks[] = [
  {
    ...
    description: '워드프레스를 사용하여 제작된 홈페이지를 Next.js로 리뉴얼하였습니다.',
    thumbnail: eurasiaImages.thumbnail,
    desktopImage: eurasiaImages.desktopImage,
  ...
  },
  {
    ...
    id: 'vstro' + index++,
    title: 'k2gbs 홈페이지',
    description: 'Next.js 리뉴얼 및 next-intl을 사용한 다국어 지원 홈페이지입니다.',
    thumbnail: k2gbsImages.thumbnail,
    desktopImage: k2gbsImages.desktopImage,
    mobileImage: k2gbsImages.mobileImage,
    bannerImage: k2gbsImages.bannerImage,
    url: null,
    date: '2023.09 ~ 2023.10',
    tags: ['반응형', '다국어 번역', 'Next.js', 'React', 'TypeScript', 'Tailwind CSS'],
    slug: 'k2gbs',
    ...
    detailContent: {
      ...
      functions: [
        {
          function: 'next-intl',
          description: 'next-intl 라이브러리를 사용하여 다국어 지원을 하였습니다.',
        },
        {
          function: 'Daisy Ui',
          description: '디자인을 위해 Daisy Ui를 사용하였습니다.',
  ...
  },
  {
    ...
    desktopImage: dpangzImages.desktopImage,
