...
const Preview = ({ previewImageData }: { previewImageData: PreviewImageType[] }) => {
  const setIsPreviewModalOpen = useModalToggle((state) => state.setIsPreviewModalOpen);
      ...
      <ModalInner>
        <div className='p-5 sm:p-6'>
          <div className='mb-2 flex justify-between gap-2'>
            ...
            <Button size='sm' variant='outline' onClick={() => setIsPreviewModalOpen(false)}>
              <MdClose />
            </Button>
          </div>
